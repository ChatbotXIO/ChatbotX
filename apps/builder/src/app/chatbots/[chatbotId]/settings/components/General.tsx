...
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/povoder";
...
const General = () => {
    ...
    const [showPicker, setShowPicker] = useState<boolean | undefined>(false);
    const [currentColor, setCurrentColor] = useState<string | undefined>("#000000")
    const [viewListTimeZones, setViewListTimeZones] = useState([])
    const [openTimeZone, setOpenTimeZone] = useState<boolean | undefined>(false)
    ...
    useEffect(() => {
        const haveListTimeZone: any = _.flatMap(timezones, 'utc')
        setViewListTimeZones(haveListTimeZone)
    }, [])
    ...
    return (
        <div className="flex flex-col gap-y-4 pt-4">
            ...
            <Card className="md:grid md:grid-cols-12">
                ...
                <CardContent className="col-span-4 flex justify-center items-center">
                    <Button className="w-full bg-red-500 hover:bg-red-700">Delete</Button>
