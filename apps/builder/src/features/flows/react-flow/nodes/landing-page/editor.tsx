...
import LandingPageEditorAction from "./landing-page-editor-action"
import { type LandingPageNodeSchema, landingPageNodeSchema } from "./schema"
...
export default function LandingPageNodeEditor({
  activeNode,
}: {
  activeNode: Node<LandingPageNodeSchema>
}) {
  ...
  const { control, getValues, watch, ...form } = useForm<LandingPageNodeSchema>(
    {
      resolver: zodResolver(landingPageNodeSchema),
    ...
    <>
      <Form {...form} getValues={getValues} control={control} watch={watch}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <LandingPageEditorAction onClick={onClickAction} />
        </form>
      </Form>
    </>
  )
