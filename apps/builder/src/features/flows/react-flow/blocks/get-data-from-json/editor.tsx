...
import {
  type GetDataFromJsonSchema,
  getDataFromJsonSchema,
  responseDataFromJsonDefaultValue,
} from "@/features/flows/react-flow/blocks/get-data-from-json/schema"
...
export const GetDataFromJsonEditor = ({
  ...
  const { control, watch, getValues, formState } = form
