...
import { createAiAssistantsAction } from "@/features/integrations/open-ai/actions/ai-assistants.action"
import { createAiAssistantsSchema } from "@/features/integrations/open-ai/schemas/ai-assistants.schema"
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button size="sm">
          <PlusIcon />
          <T keyName="aiAssistants.addBtn" />
        </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t("aiAssistants.create.title")}</DialogTitle>
          <DialogDescription />
        </DialogHeader>
