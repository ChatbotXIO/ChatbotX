...
> = {
  ...
  [StepType.getRow]: getSpreadsheetRow,
  [StepType.clearRow]: clearSpreadsheetRow,
  [StepType.getRandomRow]: getSpreadsheetRandomRow,
  [StepType.sendData]: sendSpreadsheetData,
  [StepType.updateRow]: updateSpreadsheetRow,
}
