...
> = {
  ...
  // AI Generate Text Steps (new format)
  [StepType.OPENAI_GENERATE_TEXT]: handleAIGenerateText,
  [StepType.GEMINI_GENERATE_TEXT]: handleAIGenerateText,
  [StepType.CLAUDE_GENERATE_TEXT]: handleAIGenerateText,
  [StepType.DEEPSEEK_GENERATE_TEXT]: handleAIGenerateText,
