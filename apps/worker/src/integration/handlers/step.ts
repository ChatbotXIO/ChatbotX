...
import {
  ...
  stepMarkConversationAsRead,
  stepMarkConversationAsUnread,
  stepSendTyping,
...
> = {
  ...
  [stepTypes.enum.markConversationAsUnread]: stepMarkConversationAsUnread,
  [stepTypes.enum.markConversationAsRead]: stepMarkConversationAsRead,
