...
CREATE INDEX "Conversation_workspaceId_sourceId_idx" ON "Conversation" ("workspaceId","sourceId");--> statement-breakpoint
...
CREATE UNIQUE INDEX "Message_workspaceId_sourceId_key" ON "Message" ("workspaceId","sourceId");--> statement-breakpoint
CREATE INDEX "Message_conversationId_idx" ON "Message" ("conversationId");--> statement-breakpoint
CREATE INDEX "Message_inboxId_idx" ON "Message" ("inboxId");--> statement-breakpoint
...
CREATE UNIQUE INDEX "ChatbotUsage_workspaceId_key" ON "ChatbotUsage" ("workspaceId");--> statement-breakpoint
...
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_inboxId_Inbox_id_fkey" FOREIGN KEY ("inboxId") REFERENCES "Inbox"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "Message" ADD CONSTRAINT "Message_inboxId_Inbox_id_fkey" FOREIGN KEY ("inboxId") REFERENCES "Inbox"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "ChatbotUsage" ADD CONSTRAINT "ChatbotUsage_workspaceId_Workspace_id_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "Workspace" ADD CONSTRAINT "Workspace_organizationId_Organization_id_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
