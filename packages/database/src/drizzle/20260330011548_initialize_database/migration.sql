...
CREATE TABLE "contact_inboxes" (
	...
	CONSTRAINT "ContactInbox_pkey" PRIMARY KEY("contact_id","inbox_id")
);
--> statement-breakpoint
...
CREATE TABLE "contacts_on_broadcasts" (
	...
	CONSTRAINT "ContactsOnBroadcasts_pkey" PRIMARY KEY("broadcast_id","contact_id")
);
--> statement-breakpoint
CREATE TABLE "contacts_on_sequences" (
	...
	"created_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	"enrolled_at" timestamp(3) DEFAULT now() NOT NULL,
...
CREATE TABLE "sequence_steps" (
	...
	"specific_date_time" timestamp(3),
...
CREATE TABLE "trigger_contact_histories" (
	...
	CONSTRAINT "TriggerContactHistory_pkey" PRIMARY KEY("id","contact_id")
);
--> statement-breakpoint
...
CREATE INDEX "Attachment_chatbotId_idx" ON "attachments" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Attachment_messageId_idx" ON "attachments" ("message_id");--> statement-breakpoint
CREATE INDEX "AutomatedResponse_chatbotId_idx" ON "automated_responses" ("chatbot_id");--> statement-breakpoint
CREATE UNIQUE INDEX "BotField_chatbotId_fieldType_name_key" ON "bot_fields" ("chatbot_id","type","name");--> statement-breakpoint
CREATE INDEX "Broadcast_chatbotId_idx" ON "broadcasts" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Broadcast_flowId_idx" ON "broadcasts" ("flow_id");--> statement-breakpoint
CREATE INDEX "Broadcast_channel_idx" ON "broadcasts" ("channel");--> statement-breakpoint
CREATE INDEX "Broadcast_schedulesAt_idx" ON "broadcasts" ("schedules_at");--> statement-breakpoint
CREATE UNIQUE INDEX "ChatbotUsage_chatbotId_key" ON "chatbot_usages" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Condition_type_sourceId_idx" ON "conditions" ("type","source_id");--> statement-breakpoint
CREATE INDEX "Condition_triggerId_idx" ON "conditions" ("trigger_id");--> statement-breakpoint
CREATE INDEX "Condition_webhookId_idx" ON "conditions" ("webhook_id");--> statement-breakpoint
CREATE INDEX "Condition_type_sourceId_triggerId_idx" ON "conditions" ("type","source_id","trigger_id");--> statement-breakpoint
CREATE INDEX "Condition_type_sourceId_webhookId_idx" ON "conditions" ("type","source_id","webhook_id");--> statement-breakpoint
CREATE UNIQUE INDEX "ContactCustomField_contactId_customFieldId_key" ON "contact_custom_fields" ("contact_id","custom_field_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Contact_chatbotId_sourceId_key" ON "contacts" ("chatbot_id","source_id");--> statement-breakpoint
CREATE INDEX "ContactsOnSequence_sequenceId_idx" ON "contacts_on_sequences" ("sequence_id");--> statement-breakpoint
CREATE INDEX "ContactsOnSequence_contactId_idx" ON "contacts_on_sequences" ("contact_id");--> statement-breakpoint
CREATE INDEX "ContactsOnSequence_chatbotId_idx" ON "contacts_on_sequences" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "ContactsOnSequence_status_nextRunAt_idx" ON "contacts_on_sequences" ("status","next_run_at");--> statement-breakpoint
CREATE INDEX "ContactsOnSequence_chatbotId_status_nextRunAt_idx" ON "contacts_on_sequences" ("chatbot_id","status","next_run_at");--> statement-breakpoint
CREATE UNIQUE INDEX "ContactsOnSequence_contactId_sequenceId_chatbotId_key" ON "contacts_on_sequences" ("contact_id","sequence_id","chatbot_id");--> statement-breakpoint
CREATE INDEX "Conversation_chatbotId_sourceId_idx" ON "conversations" ("chatbot_id","source_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Conversation_contactId_key" ON "conversations" ("contact_id");--> statement-breakpoint
CREATE INDEX "ConversationParticipant_chatbotId_idx" ON "conversation_participants" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "ConversationParticipant_conversationId_idx" ON "conversation_participants" ("conversation_id");--> statement-breakpoint
CREATE UNIQUE INDEX "ConversationParticipant_conversationId_userId_key" ON "conversation_participants" ("conversation_id","user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "CustomField_chatbotId_fieldType_name_key" ON "custom_fields" ("chatbot_id","type","name");--> statement-breakpoint
CREATE INDEX "Folder_chatbotId_idx" ON "folders" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Folder_parentId_idx" ON "folders" ("parent_id");--> statement-breakpoint
CREATE INDEX "Inbox_chatbotId_idx" ON "inboxes" ("chatbot_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Inbox_chatbotId_channel_sourceId_key" ON "inboxes" ("channel","source_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationGemini_chatbotId_key" ON "integration_geminis" ("chatbot_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationGemini_integrationId_key" ON "integration_geminis" ("integration_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationGoogleSheets_integrationId_key" ON "integration_google_sheets" ("integration_id");--> statement-breakpoint
CREATE INDEX "IntegrationMessenger_chatbotId_idx" ON "integration_messengers" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "IntegrationMessenger_welcomeFlowId_idx" ON "integration_messengers" ("welcome_flow_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationMessenger_inboxId_key" ON "integration_messengers" ("inbox_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationMessenger_pageId_key" ON "integration_messengers" ("page_id");--> statement-breakpoint
CREATE INDEX "Integration_chatbotId_idx" ON "integrations" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Integration_chatbotId_integrationType_key" ON "integrations" ("chatbot_id","integration_type");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationOpenAI_integrationId_key" ON "integration_open_ais" ("integration_id");--> statement-breakpoint
CREATE INDEX "IntegrationWebchat_chatbotId_idx" ON "integration_webchats" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "IntegrationWebchat_inboxId_idx" ON "integration_webchats" ("inbox_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationWebchat_inboxId_key" ON "integration_webchats" ("inbox_id");--> statement-breakpoint
CREATE INDEX "IntegrationWebchat_welcomeFlowId_idx" ON "integration_webchats" ("welcome_flow_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationWhatsapp_inboxId_key" ON "integration_whatsapps" ("inbox_id");--> statement-breakpoint
CREATE INDEX "IntegrationZalo_chatbotId_idx" ON "integration_zalos" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "IntegrationZalo_fallbackFlowId_idx" ON "integration_zalos" ("fallback_flow_id");--> statement-breakpoint
CREATE UNIQUE INDEX "IntegrationZalo_inboxId_key" ON "integration_zalos" ("inbox_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Invitation_code_key" ON "invitations" ("code");--> statement-breakpoint
CREATE INDEX "Message_chatbotId_idx" ON "messages" ("chatbot_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Message_chatbotId_sourceId_key" ON "messages" ("chatbot_id","source_id");--> statement-breakpoint
CREATE INDEX "Message_conversationId_idx" ON "messages" ("conversation_id");--> statement-breakpoint
CREATE INDEX "Message_inboxId_idx" ON "messages" ("inbox_id");--> statement-breakpoint
CREATE INDEX "Message_senderType_senderId_idx" ON "messages" ("sender_type","sender_id");--> statement-breakpoint
CREATE INDEX "Organization_domain_idx" ON "organizations" ("domain");--> statement-breakpoint
CREATE UNIQUE INDEX "Organization_slug_key" ON "organizations" ("slug");--> statement-breakpoint
CREATE UNIQUE INDEX "Reflink_chatbotId_name_key" ON "reflinks" ("chatbot_id","name");--> statement-breakpoint
...
CREATE INDEX "SequenceEvent_chatbotId_occurredAt_idx" ON "sequence_events" ("chatbot_id","occurred_at");--> statement-breakpoint
CREATE INDEX "SequenceEvent_contactId_occurredAt_idx" ON "sequence_events" ("contact_id","occurred_at");--> statement-breakpoint
CREATE INDEX "SequenceEvent_sequenceId_eventType_idx" ON "sequence_events" ("sequence_id","event_type");--> statement-breakpoint
CREATE INDEX "Sequence_folderId_idx" ON "sequences" ("folder_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Sequence_chatbotId_name_key" ON "sequences" ("chatbot_id","name");--> statement-breakpoint
CREATE INDEX "SequenceStep_sequenceId_idx" ON "sequence_steps" ("sequence_id");--> statement-breakpoint
CREATE INDEX "SequenceStep_flowId_idx" ON "sequence_steps" ("flow_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Session_token_key" ON "sessions" ("token");--> statement-breakpoint
CREATE INDEX "Spreadsheet_chatbotId_idx" ON "spreadsheets" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Spreadsheet_chatbotId_spreadsheetId_idx" ON "spreadsheets" ("chatbot_id","spreadsheet_id");--> statement-breakpoint
CREATE INDEX "Spreadsheet_spreadsheetId_idx" ON "spreadsheets" ("spreadsheet_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Tag_chatbotId_name_key" ON "tags" ("chatbot_id","name");--> statement-breakpoint
CREATE INDEX "Tag_folderId_idx" ON "tags" ("folder_id");--> statement-breakpoint
CREATE INDEX "TriggerContactHistory_triggerId_contactId_idx" ON "trigger_contact_histories" ("trigger_id","contact_id");--> statement-breakpoint
CREATE INDEX "TriggerContactHistory_contactId_idx" ON "trigger_contact_histories" ("contact_id");--> statement-breakpoint
CREATE INDEX "TriggerContactHistory_chatbotId_idx" ON "trigger_contact_histories" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "TriggerExecution_triggerId_contactId_idx" ON "trigger_executions" ("trigger_id","contact_id");--> statement-breakpoint
CREATE INDEX "TriggerExecution_chatbotId_idx" ON "trigger_executions" ("chatbot_id");--> statement-breakpoint
CREATE UNIQUE INDEX "Trigger_chatbotId_name_key" ON "triggers" ("chatbot_id","name");--> statement-breakpoint
CREATE INDEX "Trigger_chatbotId_idx" ON "triggers" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Trigger_folderId_idx" ON "triggers" ("folder_id");--> statement-breakpoint
CREATE INDEX "Trigger_chatbotId_active_idx" ON "triggers" ("chatbot_id","active");--> statement-breakpoint
CREATE UNIQUE INDEX "TriggerStats_triggerId_date_key" ON "trigger_stats" ("trigger_id","date");--> statement-breakpoint
CREATE INDEX "TriggerStats_triggerId_date_idx" ON "trigger_stats" ("trigger_id","date");--> statement-breakpoint
CREATE INDEX "TriggerStats_chatbotId_date_idx" ON "trigger_stats" ("chatbot_id","date");--> statement-breakpoint
CREATE UNIQUE INDEX "User_email_key" ON "users" ("email");--> statement-breakpoint
CREATE INDEX "Webhook_chatbotId_idx" ON "webhooks" ("chatbot_id");--> statement-breakpoint
CREATE INDEX "Webhook_folderId_idx" ON "webhooks" ("folder_id");--> statement-breakpoint
CREATE INDEX "Webhook_chatbotId_active_idx" ON "webhooks" ("chatbot_id","active");--> statement-breakpoint
CREATE UNIQUE INDEX "WhatsappMessageTemplate_integrationWhatsappId_sourceId_key" ON "whatsapp_message_templates" ("integration_whatsapp_id","source_id");--> statement-breakpoint
...
ALTER TABLE "aimcp_servers" ADD CONSTRAINT "aimcp_servers_chatbot_id_chatbots_id_fkey" FOREIGN KEY ("chatbot_id") REFERENCES "chatbots"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "folders" ADD CONSTRAINT "Folder_parentId_fkey" FOREIGN KEY ("parent_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sequences" ADD CONSTRAINT "sequences_folder_id_folders_id_fkey" FOREIGN KEY ("folder_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sequence_steps" ADD CONSTRAINT "sequence_steps_flow_id_flows_id_fkey" FOREIGN KEY ("flow_id") REFERENCES "flows"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "webhooks" ADD CONSTRAINT "webhooks_chatbot_id_chatbots_id_fkey" FOREIGN KEY ("chatbot_id") REFERENCES "chatbots"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
