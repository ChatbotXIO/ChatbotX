...
export const aiTextToSpeechSchema = z.object({
  ...
  model: aiTextToSpeechModelTypes.default(
    aiTextToSpeechModelTypes.enum["gpt-4o-mini-tts"],
  ),
  message: z.string().trim().min(1),
  voiceType: aiTextToSpeechVoiceTypes.default(
    aiTextToSpeechVoiceTypes.enum.alloy,
  ),
