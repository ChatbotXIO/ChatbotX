...
widely used online-status-tracker model — see §9 of
`docs/whatsapp-calling-parity-plan.md` for the full record. ONE
...
strict like the other two paths. See
`docs/whatsapp-calling-parity-plan.md` §9 for the review that
raised this.

### §3.3 connection-count load test — result

Ran the throwaway load test described in §3.3 of
`docs/whatsapp-calling-parity-plan.md` against the REAL
